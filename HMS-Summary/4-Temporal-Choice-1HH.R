...
pdf(file=paste(graph_dir, "/figs/HMS-Temporal-Switching-BAfter-1HH.pdf", sep=""), width=8, height=5)
...
pdf(file=paste(graph_dir, "/figs/HMS-Temporal-Switching-1HH.pdf", sep=""), width=8, height=5)
...
pdf(file=paste(graph_dir, "/figs/HMS-Temporal-Switching-Flavor-BAfter-1HH.pdf", sep=""), width=8, height=5)
ggplot(T_purchases[, .(Percent, Status)], aes(Percent, fill = Status)) + 
...
md01 = round(median(T_treat_ctrl[treat==0 & after==1, Percent]), 2)
md11 = round(median(T_treat_ctrl[treat==1 & after==1, Percent]), 2)
pdf(file=paste(graph_dir, "/figs/HMS-Temporal-Switching-Flavor-1HH.pdf", sep=""), width=8, height=5)
ggplot(T_treat_ctrl[, .(Percent, Status, bafter)], aes(Percent, fill = Status)) + 
  labs(x = "Percent of Trips Choosing a Subset of Brands and Flavors of Last Trip") + 
  geom_histogram(alpha = 0.5, aes(y = ..density..), binwidth=0.05, position = 'identity') +
  annotate("text", x = 0.5, y = 3.5, 
...
pdf(file=paste(graph_dir, "/figs/HMS-Temporal-Switching-Flavor-BAfter-Cond-1HH.pdf", sep=""), width=8, height=5)
ggplot(T_purchases[, .(Percent, Status)], aes(Percent, fill = Status)) + 
  labs(x = "Percent of Trips Choosing a Subset of Brands and Flavors of Last Trip") + 
  geom_histogram(alpha = 0.5, aes(y = ..density..), binwidth=0.05, position = 'identity') +
...
md01 = round(median(T_treat_ctrl[treat==0 & after==1, Percent]), 2)
md11 = round(median(T_treat_ctrl[treat==1 & after==1, Percent]), 2)
pdf(file=paste(graph_dir, "/figs/HMS-Temporal-Switching-Flavor-Cond-1HH.pdf", sep=""), width=8, height=5)
ggplot(T_treat_ctrl[, .(Percent, Status, bafter)], aes(Percent, fill = Status)) + 
  labs(x = "Percent of Trips Choosing a Subset of Brands and Flavors of Last Trip") + 
  geom_histogram(alpha = 0.5, aes(y = ..density..), binwidth=0.05, position = 'identity') +
  annotate("text", x = 0.5, y = 3.5, 
