...
# Merge demo info -- not much changed for 2 years!
if (one_person_hh){
  # hh[, panel_year:=panel_year-2]
...
pdf(file=paste(graph_dir, "/figs/holders_by_year-1HH.pdf", sep=""), width=7, height=5)
...
# HHI Before Adoption
pdf(file=paste(graph_dir, "/figs/HMS-Flavor-HHI-BeforeAdoption-1HH.pdf", sep=""), width=8, height=5)
...
pdf(file=paste(graph_dir, "/figs/HMS-Flavor-HHI-HH-BAfter-1HH.pdf", sep=""), width=8, height=5)
...
pdf(file=paste(graph_dir, "/figs/HMS-Flavor-HHI-BAPanel-1HH.pdf", sep=""), width=8, height=5)
...
pdf(file=paste(graph_dir, "/figs/HMS-Flavor-CR-BAdoption-1HH.pdf", sep=""), 
    width=8, height=5)
...
# HHI Before Adoption
pdf(file=paste(graph_dir, "/figs/HMS-HHI-BeforeAdoption-1HH.pdf", sep=""), width=8, height=5)
...
pdf(file=paste(graph_dir, "/figs/HMS-HHI-HH-BAfter-1HH.pdf", sep=""), width=8, height=5)
...
pdf(file=paste(graph_dir, "/figs/HMS-HHI-BAPanel-1HH.pdf", sep=""), width=8, height=5)
ggplot(pbr_temp, aes(hhi, fill = Type)) + labs(x = "HHI") + 
  geom_histogram(alpha = 0.5, aes(y = ..density..), binwidth=250, position = 'identity') +
  theme(legend.justification=c(1,1), legend.position=c(1,1)) + facet_grid(~Status)
dev.off()
...
pbr_temp[, `:=`(Status = factor(ifelse(holder==0, "Before Adoption", "After Adoption"),
                                levels=c("Before Adoption", "After Adoption")),
                Type = toupper(variable))]
pdf(file=paste(graph_dir, "/figs/HMS-CR-BAdoption-1HH.pdf", sep=""), 
    width=8, height=5)
ggplot(pbr_temp, aes(Share, fill = Status)) + labs(x = "Expenditure Share") + 
  geom_histogram(alpha = 0.5, aes(y = ..density..), binwidth=0.05, position = 'identity') +
  theme(legend.justification=c(1,1), legend.position=c(1,1)) + facet_grid(~Type)
...
# HHI Before Adoption 
pdf(file=paste(graph_dir, "/figs/HMS-HHI-Before-Treat-1HH.pdf", sep=""), width=8, height=5)
par(mfrow=c(1,2))
...
# HHI After Adoption 
pdf(file=paste(graph_dir, "/figs/HMS-HHI-After-Treat-1HH.pdf", sep=""), width=8, height=5)
par(mfrow=c(1,2))
...
# HHI Panel 
pdf(file=paste(graph_dir, "/figs/HMS-HHI-Panel-1HH.pdf", sep=""), width=8, height=5)
...
pdf(file=paste(graph_dir, "/figs/HMS-Spending-Before-Treat-1HH.pdf", sep=""), width=8, height=5)
par(mfrow=c(1,2))
...
pdf(file=paste(graph_dir, "/figs/HMS-Spending-After-Treat-1HH.pdf", sep=""), width=8, height=5)
par(mfrow=c(1,2))
...
pdf(file=paste(graph_dir, "/figs/HMS-Spending-BAfter-1HH.pdf", sep=""), width=8, height=5)
par(mfrow=c(1,2))
hist(treat_ctrl[treat==1 & after==0 & annual_spent<=500, annual_spent], xlab="Annual Spending", 
...
# Spending After Adoption 
pdf(file=paste(graph_dir, "/figs/HMS-Spending-Panel-1HH.pdf", sep=""), width=8, height=5)
