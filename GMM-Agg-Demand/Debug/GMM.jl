...
using FastGaussQuadrature, Distributions, Optim
...
@sync broad_mpi(:(include("Scripts/GMM-Agg-Demand/Debug/Initialization.jl")))
...
function main(listofmarkets)
  ...
  # Optimize theta
  GMMfun(x::Float64) = GMMObj(x, IV_WMat, listofmarkets)
  result = optimize(GMMfun, 0.0, 10.0)
  sig_root = result.minimizer
  obj = result.minimum
