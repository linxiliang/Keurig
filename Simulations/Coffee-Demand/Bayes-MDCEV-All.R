...
# Directories
setwd("~/Keurig")
code_dir = "Scripts/Simulations/Coffee-Demand/"
input_dir = "Data/Simulation-Data/"
...
load(paste(input_dir,"Simulated-Purchases.RData",sep=""))
...
save(hh_code_list, bhatd, sigd, bindv, bnames, 
     file = paste(output_dir, "Simulated-All-30000.RData", sep = ""))
stopCluster(cl)
