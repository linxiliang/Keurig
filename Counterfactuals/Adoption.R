...
thirdp_brands = setdiff(unique(retailer_panel[keurig==1, brand_descr]), c(owned, licensed))
...
hhValFun<-function(i){
  ...
  hh_agg[, `:=`(uall1=uall1_cum/1000, uall2=uall2_cum/1000, uall3=uall3_cum/1000, ugrd=ugrd_cum/1000, idx=NULL)]
