...
coffee_related_trips = unique(purchases[product_module_code==1463, .(trip_code_uc)])
...
purchases=purchases[products[, .(upc, upc_ver_uc, ptype, brand_descr, size1_amount, multi, roast, flavored, 
...
# Defined as trips to retailers that the HH made at least one purchase in coffee
...
selected_brand_list = unique(brand_type_sales[(as.integer(keurig)==1 & cumshare<=0.96) | 
                                                (as.integer(keurig)==0 & cumshare<=0.92), brand_descr]) 
...
setkeyv(retailer_panel_1, c("retailer_code", "dma_code", "brand_descr", "keurig", "size1_amount", "roast",  
                            "flavored", "kona", "colombian", "sumatra", "wb", "week_end"))
setkeyv(product_panel, c("retailer_code", "dma_code", "brand_descr", "keurig", "size1_amount", "roast",
                         "flavored", "kona", "colombian", "sumatra", "wb", "week_end"))
...
retailer_panel_1 = retailer_panel_1[product_panel[, .(retailer_code, dma_code, brand_descr, keurig, 
                                                      size1_amount, roast, flavored, kona, colombian, 
...
retailer_panel_1[, p_temp1 := mean(price, na.rm=TRUE), by = c("retailer_code", "month", "brand_descr", "keurig", 
                                                              "size1_amount")]
...
move = move[products[,.(upc, upc_ver_uc, brand_descr, keurig, size1_amount,
                        roast, flavored, kona, colombian, sumatra, wb)], nomatch=0L]
...
retailer_panel_no_purch[, `:=`(brand_descr="0NOTHING", keurig=0, size1_amount=0, roast=0, flavored=0,
                               kona=0, colombian=0, sumatra=0, wb=0, price=0)]
...
hh_prod_panel[, keurig:=as.integer(keurig)]
...
hh_prod_panel = focal_purch[, .(trip_code_uc, brand_descr, keurig, size1_amount, quantity, 
                                total_price_paid, coupon_value, total_spent)][hh_prod_panel]
...
hh_prod_panel[, sum_quantity:=as.integer(sum(quantity)), by ="trip_code_uc"]
...
brand_size_type_sales = brand_size_type_sales[rcumshare<=0.8, .(dma_code, keurig, brand_descr, size1_amount, 
...
hh_brand_size_sales = hh_brand_size_sales[rcumshare<=0.95, .(household_code, keurig, brand_descr, size1_amount, 
                                                             roast, flavored, kona, colombian, sumatra, wb, rshare)]

# Merge the criteria into the hh_prod_panel
onames = names(hh_prod_panel)
setkeyv(brand_size_type_sales, c("dma_code", "keurig", "brand_descr", "size1_amount", "roast", 
                                 "flavored", "kona", "colombian", "sumatra", "wb"))
setkeyv(hh_prod_panel, c("dma_code", "keurig", "brand_descr", "size1_amount", "roast", 
                         "flavored", "kona", "colombian", "sumatra", "wb"))
hh_prod_panel = brand_size_type_sales[hh_prod_panel]
setkeyv(hh_brand_size_sales, c("household_code", "keurig", "brand_descr", "size1_amount", "roast", 
                               "flavored", "kona", "colombian", "sumatra", "wb"))
setkeyv(hh_prod_panel, c("household_code", "keurig", "brand_descr", "size1_amount", "roast", 
                         "flavored", "kona", "colombian", "sumatra", "wb"))
...
save(hh_market_prod, hh_demo, file = paste(output_dir,"/Coffee-Panel-Cond-Purchase-Flavor.RData", sep=""))
stopxxx
