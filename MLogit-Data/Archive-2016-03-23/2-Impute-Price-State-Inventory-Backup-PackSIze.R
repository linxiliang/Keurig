...
retailer_panel[keurig==1, ptype := "KEURIG"]
...
hh_prod_panel = focal_purch[, .(trip_code_uc, brand_descr, keurig, size1_amount, quantity, total_price_paid, coupon_value)][hh_prod_panel]
...
hh_prod_panel[keurig_c==1 & brand_descr=="0NOTHING", ptype := "KEURIG"]
hh_prod_panel[keurig_c==0 & ptype_lag=="SENSEO" & brand_descr=="0NOTHING", ptype := "SENSEO"]
hh_prod_panel[keurig_c==0 & ptype_lag=="GUSTO" & brand_descr=="0NOTHING", ptype := "GUSTO"]
hh_prod_panel[keurig_c==0 & ptype_lag=="TASSIMO" & brand_descr=="0NOTHING", ptype := "TASSIMO"]
hh_prod_panel[keurig_c==0 & ptype_lag=="VUE" & brand_descr=="0NOTHING", ptype := "VUE"]
...
hh_market_prod[keurig_c==1 & brand_descr_c %in% top_keurig_brands, 
...
name_order = c("hh", "t", "brand", "coef1", bvars, "keurig", "coef2", "hassle", "price", "inventory", 
               "kinventory", "sinventory", "sinvsq", "Tj", "Tjsq", "brand_lag", "brand_cum", 
               "brand_cum_sq", "brand_cum_log", "purchased")
