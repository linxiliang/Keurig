...
purchases=purchases[products[, .(upc, upc_ver_uc, ptype, brand_descr, size1_amount, multi, flavored, 
...
setkeyv(retailer_panel_1, c("retailer_code", "brand_descr", "keurig", "size1_amount", "flavored", 
                            "kona", "colombian", "sumatra", "wb", "week_end"))
setkeyv(product_panel, c("retailer_code", "brand_descr", "keurig", "size1_amount", "flavored", 
                         "kona", "colombian", "sumatra", "wb", "week_end"))
nameorder = names(retailer_panel_1)
retailer_panel_1 = retailer_panel_1[product_panel[, .(retailer_code, brand_descr, keurig, 
                                                      size1_amount, flavored, kona, colombian, 
