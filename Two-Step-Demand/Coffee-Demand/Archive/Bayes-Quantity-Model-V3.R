...
clusterExport(cl,c('ubar', 'll_linear', 'hh_market_prod', 'XMat', 'np', 'nt', 
                   'nh', 'pif_linear', 'rwmhd_linear', 's2', 'a', 'b'))
...
save(bhatd, sigd, Thatd, Tvd, bindv, file = paste(output_dir, "Normal-MCMC.RData", sep = ""))
