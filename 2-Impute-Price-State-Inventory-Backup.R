...
dma_hh_list = unique(hh_prod_panel[as.integer(dma_code)==501, household_code])
...
top_brands = bpurch[(nb>=100 & grepl("KEURIG", brand_descr_c)) | (nb>=300) , brand_descr_c]
...
name_order = c("household_code", "trip_code_uc", "hh", "t", "brand_descr", "brand", bvars, "keurig",  "price", 
               "size1_amount", "brand_lag", "brand_cum", "brand_cum_sq", "brand_cum_log", "total_spent", "purchased")
hh_market_prod = hh_market_prod[, name_order, with = FALSE]

save(hh_market_prod, hh_demo, file = paste(output_dir,"/NewYork.RData", sep=""))
stopxxx
